  ...
  <div class="tabmenu">
   ...
   <div class="ncu-form-style">
	    	...
	    	<dt ><em class="pngFix"></em><?php echo $lang['voucher_template_image'].$lang['nc_colon']; ?></dt>
	     	<dd>
	      	<div style="clear:both; padding-top:10px;">
	      		...
	      		<img onload="javascript:DrawImage(this,220,95);" src="<?php echo SiteUrl.DS.ATTACH_VOUCHER.DS.$_SESSION['store_id'].DS.$output['t_info']['voucher_t_customimg'];?>"/>
	      		<?php }?>
	      	</div>
	      </dd>
	    </dl>	      
	    ...
	    <dl class="bottom">
	      <dt>&nbsp;</dt>
	      <dd>
	      	<input type="button" class="submit" onclick="window.location='index.php?act=store_voucher&op=templatelist'"  value="<?php echo $lang['voucher_template_backlist'];?>" />
	      </dd>
	    </dl>
	</div>
</div>