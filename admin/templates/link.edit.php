  ...
  <form id="link_form" enctype="multipart/form-data" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" for="link_url"><?php echo $lang['link_index_link'];?>:</label></td>
        </tr>
        <tr class="noborder">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"><img class="show_image" src="<?php echo TEMPLATES_PATH;?>/images/preview.png">
            <div class="type-file-preview"><img src="<?php echo SiteUrl.DS.ATTACH_LINK.DS.$output['link_array']['link_pic'];?>"></div>
