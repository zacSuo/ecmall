    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover edit row">
          ...
          <td class="sort"><span class="tooltip editable" title="<?php echo $lang['nc_editable'];?>" required="1" fieldid="<?php echo $v['activity_id'];?>" ajax_branch='activity_sort' fieldname="activity_sort" nc_type="inline_edit" ><?php echo $v['activity_sort'];?></span></td>
          <td class="name"><span class="tooltip editable" title="<?php echo $lang['nc_editable'];?>" required="1" fieldid="<?php echo $v['activity_id'];?>" ajax_branch='activity_title' fieldname="activity_title" nc_type="inline_edit" ><?php echo $v['activity_title'];?></span></td>
          <td><div class="link-logo"><span class="thumb size-logo"><i></i><img height="31" width="88" src="<?php if(is_file(BasePath.DS.ATTACH_ACTIVITY.DS.$v['activity_banner'])){echo SiteUrl."/".ATTACH_ACTIVITY."/".$v['activity_banner'];}else{echo SiteUrl."/templates/".TPL_NAME."/images/sale_banner.jpg";}?>" onload="javascript:DrawImage(this,88,31);" /></span></div></td>
...
<script src="<?php echo RESOURCE_PATH."/js/jquery-ui/jquery.ui.js";?>"></script> 
