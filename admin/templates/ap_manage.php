      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search tooltip" title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a href="JavaScript:void(0);" onclick=window.location.href='index.php?act=adv&op=ap_manage' class="btns tooltip" title="<?php echo $lang['adv_all']; ?>"><span><?php echo $lang['adv_all']; ?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th class="align-center"><?php echo $lang['ap_price'];?></th>
          ...
          <th class="align-center"><span class="paixv"><a href="index.php?act=adv&op=ap_manage&order=clicknum"><?php echo $lang['ap_click_num'];?>ˇ</a></span></th>
        ...
        <tr class="hover">
          ...
          <td class="align-center"><?php
						switch($v['ap_class']){
							...
							case '2':echo $lang['adv_slide'];break;
          ...
          <td class="align-center"><?php 
					...
					?></td>
          <td class="align-center"><?php echo $v['ap_price']; ?></td>
          <td class="align-center"><?php
					 $i    = 0;
					 $time = time(); 
					 ...
					 echo $i;
					?></td>
          <td class="align-center"><?php echo $v['adv_num']; ?></td>
          <td class="align-center yes-onoff"><?php if($v['is_use'] == '0'){ ?>
            <a href="JavaScript:void(0);" class="tooltip disabled" ajax_branch="is_use" nc_type="inline_edit" fieldname="is_use" fieldid="<?php echo $v['ap_id']?>" fieldvalue="0" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo TEMPLATES_PATH;?>/images/transparent.gif"></a>
            <?php }else { ?>
            <a href="JavaScript:void(0);" class="tooltip enabled" ajax_branch="is_use" nc_type="inline_edit" fieldname="is_use" fieldid="<?php echo $v['ap_id']?>" fieldvalue="1" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo TEMPLATES_PATH;?>/images/transparent.gif"></a>
            <?php } ?></td>
          <td class="align-center"><?php echo $v['click_num']; ?></td>
          <td class="w132 align-center"><a href='index.php?act=adv&op=ap_edit&ap_id=<?php echo $v['ap_id'];?>'><?php echo $lang['nc_edit'];?></a> | <a href="javascript:if(confirm('<?php echo $lang['nc_ensure_del'];?>'))window.location = 'index.php?act=adv&op=ap_manage&do=del&ap_id=<?php echo $v['ap_id'];?>';"><?php echo $lang['nc_del'];?></a> | <input name="ap_code" id="ap_code_<?php echo $v['ap_id']; ?>" type="hidden" value='<script type="text/javascript" src="<?php echo "<?php echo SiteUrl;?>/index.php?act=adv&op=advshow&ap_id=".$v['ap_id'];?>"></script>' /><a href="javascript:void(0)" id="get_code_<?php echo $v['ap_id']; ?>"><?php echo $lang['ap_get_js'];?></a></td>
          <script type="text/javascript">
$(document).ready(function(){
	$("#get_code_<?php echo $v['ap_id']; ?>").click(function(){
		copyToClipBoard($("#ap_code_<?php echo $v['ap_id'];?>").val(),<?php echo $v['ap_id'];?>);
	});
});
</script> 
        </tr>
...
function copyToClipBoard(txt, id)
{
    ...
    { 
        ...
        alert("<?php echo $lang['adv_index_copy_to_clipboard_succ'];?>!");
    }
