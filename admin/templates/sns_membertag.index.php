    ...
    <table class="table tb-type2">
      ...
      <tbody>
        <tr class="hover edit">
          ...
          <td class="w48 sort"><span title="<?php echo $lang['nc_editable'];?>" ajax_branch="membertag_sort" datatype="number" fieldid="<?php echo $v['mtag_id'];?>" fieldname="mtag_sort" nc_type="inline_edit" class="editable tooltip"><?php echo $v['mtag_sort'];?></span></td>
          <td class="w50pre name"><span title="<?php echo $lang['nc_editable'];?>" required="1" fieldid="<?php echo $v['mtag_id'];?>" ajax_branch="membertag_name" fieldname="mtag_name" nc_type="inline_edit" class="editable tooltip"><?php echo $v['mtag_name'];?></span></td>
          <td class="align-center yes-onoff"><?php if($v['mtag_recommend'] == 0){ ?>
            <a href="JavaScript:void(0);" class="tooltip disabled" fieldvalue="0" fieldid="<?php echo $v['mtag_id'];?>" ajax_branch="membertag_recommend" fieldname="mtag_recommend" nc_type="inline_edit" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo TEMPLATES_PATH;?>/images/transparent.gif"></a>
            <?php }else{ ?>
            <a href="JavaScript:void(0);" class="tooltip enabled" fieldvalue="1" fieldid="<?php echo $v['mtag_id'];?>" ajax_branch="membertag_recommend" fieldname="mtag_recommend" nc_type="inline_edit" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo TEMPLATES_PATH;?>/images/transparent.gif"></a>
            <?php } ?></td>
