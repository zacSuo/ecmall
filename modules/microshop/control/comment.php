    ...
    public function comment_saveOp() {
        ...
        if(!empty($_SESSION['member_id'])) {
            ...
            if($result) {
                ...
                $data['member_link'] = MICROSHOP_SITEURL.'/index.php?act=home&member_id='.$_SESSION['member_id'];
                ...
                if(isset($_POST['share_app_items'])) {
                    ...
                    $info['type'] = $_GET['type'];
                    $info['url'] = MICROSHOP_SITEURL.DS."index.php?act={$_GET['type']}&op=detail&{$_GET['type']}_id=".$_POST['comment_id'].'#widgetcommenttitle';
