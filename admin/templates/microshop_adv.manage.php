...
$(document).ready(function(){
    //行内ajax编辑
    $('span[nc_type="adv_sort"]').inline_edit({act: 'microshop',op: 'update_adv_sort'});
});
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w48 sort"><span nc_type="adv_sort" column_id="<?php echo $val['adv_id'];?>" title="<?php echo $lang['nc_editable'];?>" class="editable tooltip"><?php echo $val['adv_sort'];?></span>
          ...
          <td class="align-center">
              ...
              <a href="javascript:submit_delete(<?php echo $val['adv_id'];?>)"><?php echo $lang['nc_delete'];?></a>
          </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
