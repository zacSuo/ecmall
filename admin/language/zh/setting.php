...
$lang['open_rewrite_tips']                  = '啓用僞靜態可以提高搜索引擎抓取<br/>如果您使用的是Apache服務器，啓用前，請先確保已開啓apache服務器的rewrite.module功能模塊，並將商城目錄下的"htaccess.txt"文件重命名爲".htaccess"。<br/>如果您使用的是IIS服務器，啓用前，請確保已正確安裝ISAPI_Rewrite，並將商城目錄下的"htaccess.txt"文件重命名爲".htaccess"，<br/>如果您使用的是Nginx服務器，啓用前，請將htaccess.txt內的nginx版僞靜態規則複制到nginx.conf中，然後重啓nginx。';
