    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <li><strong><?php echo $lang['admin_pointorder_info_shipinfo_zipcode'];?>:</strong><?php echo $output['order_info']['point_zipcode'];?></li>
      ...
      <tr>
        <td><table class="table tb-type2 goods ">
            <tbody>
              ...
              <tr>
                <td class="w60 picture"><div class="size-56x56"><span class="thumb size-56x56"><i></i><a href="<?php echo SiteUrl;?>/index.php?act=pointprod&op=pinfo&id=<?php echo $v['point_goodsid'];?>" target="_blank" class="order_info_pic"> <img src="<?php echo SiteUrl.DS.ATTACH_POINTPROD.DS.$v['point_goodsimage'].'_small.'.get_image_type($v['point_goodsimage']);?>" onerror="this.src='<?php echo SiteUrl.DS.defaultGoodsImage('tiny');?>'" onload="javascript:DrawImage(this,56,56);" /></a></span></div></td>
                <td class="w50pre"><a href="<?php echo SiteUrl;?>/index.php?act=pointprod&op=pinfo&id=<?php echo $v['point_goodsid'];?>" target="_blank"><?php echo $v['point_goodsname'];?></a></td>
