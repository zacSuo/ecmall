    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
		  ...
		  <div class="size-56x56"><span class="thumb size-56x56"><img height="56" width="56" src="<?php echo $v['goods_image']?SiteUrl.'/'.ATTACH_FLEAS.'/'.$v['member_id'].'/'.str_replace('_small', '_tiny', $v['goods_image']):TEMPLATES_PATH.'/images/default_goods_image.gif';?>" onload="javascript:DrawImage(this,56,56);"/></span></div></td>
...
<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/js/common_flea_select.js" charset="utf-8"></script>
