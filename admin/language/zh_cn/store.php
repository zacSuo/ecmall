...
$lang['add_store_ok']          = '新增店铺成功。';
$lang['add_fail_fail']         = '新增店铺失败。';
$lang['update_store_ok']       = '编辑店铺成功。';
$lang['update_fail_fail']      = '编辑店铺失败。';
$lang['store_no_exist']        = '该店铺不存在。';
$lang['store_no_meet']         = '店铺不符合要求';
$lang['operation_ok']          = '操作成功。';
$lang['please_sel_del_store']  = '请选择要删除的内容!';
$lang['please_sel_store']  = '请选择要操作的店铺!';
$lang['del_store_ok']          = '删除店铺成功。';
$lang['address_no_null']       = '地区不能为空';
$lang['please_sel_edit_store'] = '请选择要编辑的店铺';
$lang['store_batch_del_ok']    = '店铺批量编辑成功!';
...
$lang['store_verify']		= '审核';
$lang['store_pass']			= '通过';
$lang['store_no_pass']		= '不通过';
$lang['store_not_by_reason']= '不通过原因';
$lang['store_auth_succeed']	= '已认证';
$lang['store_auth_fail']	= '未认证';
$lang['store_verify_ing']	= '申请中';
$lang['store_verify_auth']	= '审核认证';
$lang['store_fail']			= '失败';
$lang['store_auth']			= '店铺认证';
$lang['member_auth']		= '店主认证';
$lang['store_auth_verify']	= '认证申请';
$lang['store_pass_auth']	= '通过认证';
$lang['please_sel_pass_auth_store'] = '请选择要通过认证的店铺';
