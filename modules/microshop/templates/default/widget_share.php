...
<textarea id="bindtooltip_module" style="display:none;">
        <div class="eject_con">
            <dl>
                <dt style="width:25%">
                <img src="<?php echo MICROSHOP_TEMPLATES_PATH;?>/images/shareicon/shareicon_@apikey.png" width="40" height="40" class="mt5 mr20">
                </dt>
                <dd style="width:75%">
            ...
            <dl class="bottom">
                ...
                <span><?php echo $lang['microshop_share_tip6'];?>
                    <a target="_blank" href="<?php echo SiteUrl;?>/api.php?act=sharebind&type=@apikey" class="ml5"><?php echo $lang['microshop_share_tip7'];?></a>
                </span>
                </dd>
            </dl>
        </div>
