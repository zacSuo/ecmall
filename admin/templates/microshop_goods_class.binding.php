...
$(document).ready(function(){
    ...
    $("#goods_class").change(function(){
        ...
        $.getJSON('index.php?act=microshop&op=get_shop_goods_class',{class_id:$(this).val()},function(data){
            if(data != null)
            {
...
<form id="add_form" method="POST" action="index.php?act=microshop&op=goods_class_binding_save">
