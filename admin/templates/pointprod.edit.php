  ...
  <form id="pointprod_form" method="post" enctype="multipart/form-data" >
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="noborder">
          <th rowspan="6" class="picture"><div class="size-200x200"><span class="thumb size-200x200"><i></i><img src="<?php echo SiteUrl.DS.ATTACH_POINTPROD.DS.$output['prod_info']['pgoods_image'];?>" onerror="this.src='<?php echo SiteUrl.DS.ATTACH_COMMON.DS.C('default_goods_image');?>'" onload="javascript:DrawImage(this,200,200);" nc_type="goods_image" /></span></div>
          </th>
      ...
      <tbody>
        <tr>
          <td colspan="10" class="required"><label><?php echo $lang['admin_pointprod_freightcharge']; ?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="radio" name="freightcharge" id="freightcharge_0" value="0" <?php if ($output['prod_info']['pgoods_freightcharge'] == 0){echo 'checked=checked';}?> onclick="showfreightcharge();"/>
            <label><?php echo $lang['admin_pointprod_freightcharge_saler']; ?></label>
            <input type="radio" name="freightcharge" id="freightcharge_1" value="1" <?php if ($output['prod_info']['pgoods_freightcharge'] == 1){echo 'checked=checked';}?> onclick="showfreightcharge();"/>
            <label><?php echo $lang['admin_pointprod_freightcharge_buyer']; ?></label></td>
          <td colspan="10" class="vatop tips"></td>
        </tr>
      </tbody>
      <tbody id="freightcharge_div">
        <tr>
          <td colspan="10" class="required"><label for="freightprice" class="validation"><?php echo $lang['admin_pointprod_freightprice']; ?>: </label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" name="freightprice" id="freightprice" class="txt" value="<?php echo $output['prod_info']['pgoods_freightprice']; ?>"/></td>
          <td colspan="10" class="vatop tips"></td>
        </tr>
      </tbody>
      <tbody>
      ...
      <tbody>
        ...
        <tr class="noborder">
          <td id="divComUploadContainer"  colspan="10" style="display:none;"  ><iframe src="index.php?act=pointprod&op=pointprod_iframe_upload&item_id=<?php echo $output['prod_info']['pgoods_id']; ?>" width="500" height="46" scrolling="no" frameborder="0"> </iframe></td>
        </tr>
        <tr>
...
//
    ...
    new SWFUpload({
		...
		post_params: {
			...
			'item_id': '<?php echo $output['prod_info']['pgoods_id']; ?>'
		},
