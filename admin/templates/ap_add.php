      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><select name="ap_class" id="ap_class">
              ...
              <option value="2"><?php echo $lang['adv_slide'];?></option>
        ...
        <tr>
          <td colspan="2" class="required"><label for="ap_price" class="validation"><?php echo $lang['ap_price_name'];?>:</label></td>
        </tr>
        <tr class="noborder">
...
$(document).ready(function(){
	...
	$('#link_form').validate({
        ...
        messages : {
            ...
            ap_price  : {
                required : '<?php echo $lang['ap_price_can_not_null']; ?>',
