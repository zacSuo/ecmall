...
<script type="text/javascript" src="<?php echo MICROSHOP_RESOURCE_PATH;?>/js/jcarousel/jquery.jcarousel.min.js" charset="utf-8"></script>
<link href="<?php echo MICROSHOP_RESOURCE_PATH;?>/js/jcarousel/skins/personal/skin.css" rel="stylesheet" type="text/css">
...
$(document).ready(function() {
    ...
    $("[nc_type='btn_sns_addfollow']").live('click',function(){
        ...
        $.getJSON("<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=home&op=add_follow", {member_id:$(this).attr('member_id')}, function(json){
            if(json.result == "true") {
                btn_add.hide();
                btn_del.show();
                if(json.message != 're') {
	...
	$("[nc_type='btn_sns_delfollow']").live('click',function(){
        ...
        var follow_count = $(this).parent().parent().find("[nc_type='fan_count']");
        $.getJSON("<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=home&op=del_follow", {member_id:$(this).attr('member_id')}, function(json){
            if(json.result == "true") {
                btn_add.show();
                btn_del.hide();
                follow_count.microshop_count({type:'-'});
        ...
        <div class="left">
            <div class="index-banner"> 
                ...
                <div class="mask"> 
                    ...
                    <img src="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.'adv'.DS.$value['adv_image'];?>" uri="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.'adv'.DS.$value['adv_image'];?>" link="<?php echo $value['adv_url'];?>"/> 
                    <?php } ?>
                </div>
                <?php } else {?>
                <img class="bigImg" src="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.'default_index_banner.jpg';?>"/>
                <?php }?>
            </div>
        </div>
  <div class="right">
    <div class="member-box">
      ...
      <dl class="welcome">
        ...
        <dd><a href="<?php echo SiteUrl.'/index.php?act=login&ref_url='.getRefUrl();?>" class="login-now"><?php echo $lang['microshop_text_login'];?></a></dd>
      </dl>
      <?php } else { ?>
      <div class="portrait"> <a href="<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=home&member_id=<?php echo $_SESSION['member_id'];?>" target="_blank"> <img src="<?php echo $member_avatar;?>" onload="javascript:DrawImage(this,72,72);" /> </a> </div>
      <dl class="welcome">
        <dt> <a href="<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=home&member_id=<?php echo $_SESSION['member_id'];?>" target="_blank"> <?php echo $output['member_info']['member_name'];?> </a> </dt>
    ...
    <div class="user-box">
      ...
      <dl class="big-gun">
        <dt class="portrait"><a href="<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=home&member_id=<?php echo $value['member_id'];?>" target="_blank"><img src="<?php echo getMemberAvatar($value['member_avatar']);?>" onload="javascript:DrawImage(this,60,60);" /></a></dt>
        <dd class="name"> <a href="<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=home&member_id=<?php echo $value['member_id'];?>" target="_blank"> <?php echo $value['member_name'];?> </a> </dd>
...
<div class="main-box personal">
  ...
  <ul id="indexPersonal" class="jcarousel-skin-personal">
    ...
    <?php $personal_image_array = getPersonalImageUrl($value,'list');?>
    <li style="background-image: url(<?php echo $personal_image_array[0];?>)"><a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=personal&op=detail&personal_id=<?php echo $value['personal_id'];?>"></a>
      <div class="arrow">&nbsp;</div>
      <dl>
        <dt><img src="<?php echo getMemberAvatar($value['member_avatar']);?>" onload="javascript:DrawImage(this,30,30);" /></dt>
        <dd> <a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=home&member_id=<?php echo $value['commend_member_id'];?>"> <?php echo $value['member_name'];?> </a>
...
<div class="main-box goods">
  ...
  <ul class="goods-class-pic">
    ...
    <?php $image_url = cthumb($value_goods['commend_goods_image'],'240x240',$value_goods['commend_goods_store_id']);?>
    <li style="background-image: url(<?php echo $image_url;?>)" ><a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=goods&op=detail&goods_id=<?php echo $value_goods['commend_id'];?>" title="<?php echo $value_goods['commend_goods_name'];?>">&nbsp;</a>
  ...
  <div class="goods-class-list">
    ...
    <dl>
      <dt><a href="<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=goods&goods_class_root_id=<?php echo $value['class_id'];?>&goods_class_menu_id=<?php echo $value_menu['class_id'];?>"><?php echo $value_menu['class_name'];?></a></dt>
    ...
    <?php } ?>
    <?php } ?>
    <div class="more"><a href="<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=goods&goods_class_root_id=<?php echo $value['class_id'];?>"><?php echo $lang['microshop_text_all'];?>...</a></div>
  </div>
</div>
<?php } ?>
<?php } ?>
  ...
  <ul class="store-top">
    ...
    <li>
      ...
      <ol nc_type="index_store" style="padding-left: 7px;">
        ...
        <li class="overall"><div class="store-pic"><img src="<?php echo getStoreLogo($output['store_list'][$i]['store_logo']);?>" onload="javascript:DrawImage(this,60,60);" /></div><i><?php echo $i+1;?></i>
          
          <dl class="store-intro">
            <dt><a href="<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=store&op=detail&store_id=<?php echo $output['store_list'][$i]['microshop_store_id'];?>" target="_blank"><?php echo $output['store_list'][$i]['store_name'];?></a></dt>
    ...
    <li>
      ...
      <ol nc_type="index_store" style="padding-left: 7px;">
        ...
        <li class="overall"> <div class="store-pic"><img src="<?php echo getStoreLogo($output['store_list'][$i]['store_logo']);?>" onload="javascript:DrawImage(this,60,60);" /></div><i><?php echo $i-4;?></i>
    ...
    <li>
      ...
      <ol nc_type="index_store" style=" background: none; padding-left: 7px;">
        ...
        <li class="overall"><div class="store-pic"><img src="<?php echo getStoreLogo($output['store_list'][$i]['store_logo']);?>" onload="javascript:DrawImage(this,60,60);" /></div><i><?php echo $i-9;?></i>
