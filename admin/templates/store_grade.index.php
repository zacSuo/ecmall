      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search tooltip" title="<?php echo $lang['nc_query']; ?>">&nbsp;</a>
            ...
            <a class="btns tooltip" href="index.php?act=store_grade&op=store_grade" title="<?php echo $lang['cancel_search'];?>"><span><?php echo $lang['cancel_search'];?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <li><?php echo $lang['store_grade_help3'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
    ...
    <table class="table tb-type2">
      <thead>
        <tr class="thead">
          ...
          <th class="align-center"><?php echo $lang['need_audit'];?></th>
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="align-center"><?php if($v['sg_confirm'] == '0'){ ?>
            <?php echo $lang['nc_no'];?>
            <?php }else { ?>
