...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      <h3><?php echo $lang['link_index_partner'];?></h3>
      <ul class="tab-base">
      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search tooltip" title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a href="index.php?act=link&op=link" class="btns tooltip" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?>
            <a href="JavaScript:void(0);" onclick="window.location.href='index.php?act=link&op=link'" class="btns tooltip" title="<?php echo $lang['link_all']; ?>"><span><?php echo $lang['link_all']; ?></span></a> <a href="JavaScript:void(0);" onclick="window.location.href='index.php?act=link&op=link&type=0'" class="btns tooltip" title="<?php echo $lang['link_pic']; ?>"><span><?php echo $lang['link_pic']; ?></span></a> <a href="JavaScript:void(0);" onclick="window.location.href='index.php?act=link&op=link&type=1'" class="btns tooltip" title="<?php echo $lang['link_word']; ?>"><span><?php echo $lang['link_word']; ?></span></a></td>
        </tr>
      </tbody>
    </table>
  </form>
    ...
    <table class="table tb-type2 nobdb">
      <thead>
        <tr class="thead">
          ...
          <th><?php echo $lang['link_index_link'];?></th>
