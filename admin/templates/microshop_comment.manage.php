            ...
            <tbody>
                ...
                <tr class="hover edit">
                    ...
                    <td>
                        ...
                        <?php } else { ?>
                        <a href="<?php echo $microshop_url.DS.'index.php?act=home&member_id='.$value['comment_member_id'];?>" target="_blank">
                            <?php echo $value['member_name'];?>
                        </a>
                        <?php } ?>
                    </td>
                    ...
                    <td>
                        ...
                        <?php } else { ?>
                        <a href="<?php echo $microshop_url.DS.'index.php?act='.$output['channel_array'][$value['comment_type']]['key'].'&op=detail&'.$output['channel_array'][$value['comment_type']]['key'].'_id='.$value['comment_object_id'];?>" target="_blank">
                            <?php echo $value['comment_object_id'];?>
                        </a>
                        <?php } ?>
                    </td>
                    <td><?php echo parsesmiles($value['comment_message']);?></td>
                    <td><a href="###" onclick="submit_delete(<?php echo $value['comment_id'];?>)"><?php echo $lang['nc_delete'];?></a></td>
                </tr>
                <?php } ?>
                <?php }else { ?>
                <tr class="no_data">
