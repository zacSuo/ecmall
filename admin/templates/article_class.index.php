      ...
      <tbody id="treet1">
        ...
        <tr class="hover edit">
          <td><?php if($v['ac_code'] == ''){ ?>
            ...
            <img src="<?php echo TEMPLATES_PATH;?>/images/tv-expandable.gif" fieldid="<?php echo $v['ac_id'];?>" status="open" nc_type="flex">
            <?php }else{ ?>
            <img fieldid="<?php echo $v['ac_id'];?>" status="close" nc_type="flex" src="<?php echo TEMPLATES_PATH;?>/images/tv-item.gif">
            <?php } ?></td>
...
<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/js/jquery.article_class.js" charset="utf-8"></script> 
