...
<table class="table tb-type2 order mtw">
  ...
  <tbody>
    ...
    <tr>
      <td><a href="JavaScript:void(0);" id="btn_refresh" class="btn" onclick="submit_delete_batch()"><span><?php echo $lang['talk_refresh'];?></span></a><a href="JavaScript:void(0);" id="btn_publish" class="btn" onclick="submit_delete_batch()"><span><?php echo $lang['talk_send'];?></span></a></td>
    </tr>
    <?php } ?>
  </tbody>
</table>
