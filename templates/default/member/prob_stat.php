...
<div class="wrap">
  ...
  <form method="get" action="index.php">
    <table class="search-form">
      ...
      <tr>
        <td><input style="cursor:pointer" type="button" value="<?php echo $lang['stat_week_ps']; ?>" id="week_flow">&nbsp;<input style="cursor:pointer" type="button" value="<?php echo $lang['stat_month_ps']; ?>" id="month_flow">&nbsp;<input style="cursor:pointer" type="button" value="<?php echo $lang['stat_year_ps']; ?>" id="year_flow"></td>
...
<script type="text/javascript">
	$(function(){
	    ...
	    $('#week_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics&op=probability_statistics';
		})
		$('#month_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics&op=probability_statistics&type=month';
		})
		$('#year_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics&op=probability_statistics&type=year';
		})
	});
</script>