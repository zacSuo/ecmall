...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
     	<li><a href="index.php?act=store&op=store_domain_setting"><span><?php echo $lang['nc_config'];?></span></a></li>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w150 align-center"><a href="index.php?act=store&op=store_domain_edit&store_id=<?php echo $v['store_id']?>"><?php echo $lang['nc_edit'];?></a> 
			 		</td>
        </tr>
        <?php } ?>
        <?php }else { ?>
