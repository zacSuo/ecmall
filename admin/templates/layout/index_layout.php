...
<link href="<?php echo TEMPLATES_PATH;?>/css/skin_0.css" rel="stylesheet" type="text/css" id="cssfile"/>
...
$(function(){   
    var $li =$("#skin li");   
		...
		$("#cssfile").attr("href","<?php echo TEMPLATES_PATH;?>/css/"+ (this.id) +".css");   
        $.cookie( "MyCssSkin" ,  this.id , { path: '/', expires: 10 });  

        $('iframe').contents().find('#cssfile2').attr("href","<?php echo TEMPLATES_PATH;?>/css/"+ (this.id) +".css"); 
    });   

    var cookie_skin = $.cookie( "MyCssSkin");   
    if (cookie_skin) {   
		$("#"+cookie_skin).addClass("selected").siblings().removeClass("selected");
		$("#cssfile").attr("href","<?php echo TEMPLATES_PATH;?>/css/"+ cookie_skin +".css"); 
      ...
      <td colspan="2" height="90" class="mainhd"><div class="layout-header"> <!-- Title/Logo - can use text instead of image -->
          ...
          <div id="topnav" class="top-nav">
            <ul>
              ...
              <li><a href="<?php echo SiteUrl;?>" target="_blank" title="<?php echo $lang['nc_homepage'];?>"><span><?php echo $lang['nc_homepage'];?></span></a></li>
            </ul>
          </div>
          ...
          <div class="toolbar">
            ...
            <div class="toolmenu"><span class="bar-btn"></span>
              <ul class="bar-list">
                ...
                <li><a href="<?php echo SiteUrl.DS.ProjectName.DS;?>" id="iframe_refresh"><?php echo $lang['nc_refresh'];?><?php echo $lang['nc_admincp']; ?></a></li>
                <li><a href="JavaScript:void(0);" onclick="openItem('db,db,website');"><?php echo $lang['nc_backup_db'];?></a></li>
                <li><a href="index.php?act=updatestat&op=index" target="workspace" ><?php echo $lang['nc_updatestat_qk']; ?></a></li>
                <li><a href="<?php echo SiteUrl.DS.ProjectName.DS;?>" title="<?php echo $lang['nc_admincp']; ?>-<?php echo $output['html_title'];?>" rel="sidebar" onclick="javascript:window.external.AddFavorite('<?php echo SiteUrl.DS.ProjectName.DS;?>', '<?php echo $lang['nc_admincp']; ?>-<?php echo $output['html_title'];?>');return false;"><?php echo $lang['nc_favorite']; ?><?php echo $lang['nc_admincp']; ?></a></li>
              </ul>
            </div>
          </div>
        </div>
