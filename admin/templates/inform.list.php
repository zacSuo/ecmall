      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search tooltip" title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a href="index.php?act=inform&op=inform_list" class="btns tooltip" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php } ?></td>
        </tr>
      </tbody>
    </table>
  ...
  <form method='post' id="list_form" action="index.php?act=voucher_price&op=voucher_price_drop">
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="line">
          <td><a href="<?php echo SiteUrl.DS.ncUrl(array('act'=>'goods','goods_id'=>$v['inform_goods_id']), 'goods');?>" target="_blank"><?php echo $v['inform_goods_name'];?></a></td>
