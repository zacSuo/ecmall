...
<script type="text/javascript">
	$(function(){
	    ...
	    $('#week_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics&op=goods_flow_statistics';
		})
		$('#month_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics&op=goods_flow_statistics&type=month';
		})
		$('#year_flow').click(function(){
	    	window.location.href = 'index.php?act=statistics&op=goods_flow_statistics&type=year';
		})
	});
</script>