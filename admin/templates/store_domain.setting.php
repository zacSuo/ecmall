  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=store&op=store_domain_list"><span><?php echo $lang['nc_domain_shop'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form method="post" id="settingForm" name="settingForm">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" for="subdomain_suffix"><?php echo $lang['suffix'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['list_setting']['subdomain_suffix'];?>" name="subdomain_suffix" id="subdomain_suffix" class="txt"></td>
          <td class="vatop tips"><?php echo $lang['demo'];?></td>
        </tr>
        <tr>
...
$(document).ready(function(){
	...
	$("#settingForm").validate({
        ...
        messages : {
            ...
            subdomain_suffix : {
                required : '<?php echo $lang['domain_suffix_null'];?>'
            },
            subdomain_length  : {
