  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['admin_evalseller_list'];?></span></a></li>
    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          ...
          <th><label for="store_name"><?php echo $lang['admin_evaluate_tomembername']?></label></th>
          <td><input class="txt" type="text" name="to_name" id="to_name" value="<?php echo $_GET['to_name'];?>" /></td>
  ...
  <table class="table tb-type2">
    ...
    <thead>
      <tr class="thead">
        ...
        <th class="w108 align-center"><?php echo $lang['admin_evaluate_tomembername'];?> </th>
    ...
    <tbody>
      ...
      <tr class="hover">
      	...
      	<td class="align-center"><?php echo $v['geval_tomembername'];?></td>
        ...
        <td class="align-center">
        	<a href="index.php?act=evaluate&op=evalgoods_info&type=seller&id=<?php echo $v['geval_id'];?>" ><?php echo $lang['nc_edit'];?></a>
