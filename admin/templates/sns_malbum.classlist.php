  ...
  <form method='post' id="form_goods">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td></td>
          <td class="w60 picture"><div class="size-44x44"><span class="thumb size-44x44"><i></i><img src="<?php if($v['ac_cover'] != ''){echo SiteUrl.DS.ATTACH_MALBUM.DS.$v['member_id'].DS.$v['ac_cover'];}else{echo SiteUrl.'/templates/'.TPL_NAME.'/images/member/default_image.png';}?>" onerror="this.src='<?php echo SiteUrl.'/templates/'.TPL_NAME.'/images/member/default_image.png';?>'" onload="javascript:DrawImage(this,44,44);"/></span></div></td>
