...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" nctype="rewrite" class="current"><span><?php echo $lang['nc_seo_url_rewrite'];?></span></a></li>
        <li><a href="JavaScript:void(0);" nctype="index"><span><?php echo $lang['seo_set_index'];?></span></a></li>
        ...
        <li><a href="JavaScript:void(0);" nctype="coupon"><span><?php echo $lang['seo_set_coupon'];?></span></a></li>
  ...
  <form method="post" name="form_rewrite">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2" class="required"><label><?php echo $lang['open_pseudo_static'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="rewrite_enabled"  class="cb-enable <?php if($output['list_setting']['rewrite_enabled'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_yes'];?>"><span><?php echo $lang['nc_yes'];?></span></label>
            <label for="rewrite_disabled" class="cb-disable <?php if($output['list_setting']['rewrite_enabled'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_no'];?>"><span><?php echo $lang['nc_no'];?></span></label>
            <input id="rewrite_enabled" name="rewrite_enabled" <?php if($output['list_setting']['rewrite_enabled'] == '1'){ ?>checked="checked"<?php } ?> value="1" type="radio">
            <input id="rewrite_disabled" name="rewrite_enabled" <?php if($output['list_setting']['rewrite_enabled'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio"></td>
          <td class="vatop tips">
      ...
      <tfoot>
        <tr class="tfoot">
          <td colspan="2" ><a href="JavaScript:void(0);" class="btn" onclick="document.form_rewrite.submit()"><span><?php echo $lang['nc_submit'];?></span></a></td>
        </tr>
      </tfoot>
    </table>
  </form>
  ...
  <form method="post" name="form_coupon" action="index.php?act=setting&op=seo_setting">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr>
          <td colspan="2" class="required"><label><?php echo $lang['seo_set_coupon'];?></label></td>
        </tr>
        <tr class="noborder">
          <td class="w96">title</td><td><input id="SEO[coupon][title]" name="SEO[coupon][title]" value="<?php echo $output['seo']['coupon']['title'];?>" class="w300" type="text"/></td>
        </tr>
        <tr class="noborder">
          <td class="w96">keywords</td><td><input id="SEO[coupon][keywords]" name="SEO[coupon][keywords]" value="<?php echo $output['seo']['coupon']['keywords'];?>" class="w300" type="text" /></td>
        </tr>
        <tr class="noborder">
          <td class="w96">description</td><td><input id="SEO[coupon][description]" name="SEO[coupon][description]" value="<?php echo $output['seo']['coupon']['description'];?>" class="w300" type="text" /></td>
        </tr>
        <tr>
          <td colspan="2" class="required"><label><?php echo $lang['seo_set_coupon_content'];?></label></td>
        </tr>
        <tr class="noborder">
          <td class="w96">title</td><td><input id="SEO[coupon_content][title]" name="SEO[coupon_content][title]" value="<?php echo $output['seo']['coupon_content']['title'];?>" class="w300" type="text" /></td>
        </tr>
        <tr class="noborder">
          <td class="w96">keywords</td><td><input id="SEO[coupon_content][keywords]" name="SEO[coupon_content][keywords]" value="<?php echo $output['seo']['coupon_content']['keywords'];?>" class="w300" type="text" /></td>
        </tr>
        <tr class="noborder">
          <td class="w96">description</td><td><input id="SEO[coupon_content][description]" name="SEO[coupon_content][description]" value="<?php echo $output['seo']['coupon_content']['description'];?>" class="w300" type="text" /></td>
        </tr>
      </tbody>
      <tfoot>
        <tr class="tfoot">
          <td colspan="2" ><a href="JavaScript:void(0);" class="btn" onclick="document.form_coupon.submit()"><span><?php echo $lang['nc_submit'];?></span></a></td>
        </tr>
      </tfoot>
    </table>
  </form>
  ...
  <form method="post" name="form_sns" action="index.php?act=setting&op=seo_setting">
    <input type="hidden" name="form_submit" value="ok" />
    <span style="display:none" nctype="hide_tag"><a>{sitename}</a><a>{name}</a></span>
    <table class="table tb-type2">
      <tbody>
