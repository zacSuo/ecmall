    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
          ...
          <td class="w48 sort"><span class="tooltip editable" title="<?php echo $lang['nc_editable'];?>" style="cursor:pointer;"  required="1" fieldid="<?php echo $v['activity_detail_id'];?>" ajax_branch='activity_detail_sort' fieldname="activity_detail_sort" nc_type="inline_edit"><?php echo $v['activity_detail_sort'];?></span></td>
          <td><a target="_blank" href="<?php echo SiteUrl;?>/index.php?act=goods&goods_id=<?php echo $v['item_id']?>"><?php echo $v['item_name'];?></a></td>
          <td><a target="_blank" href="<?php echo SiteUrl;?>/index.php?act=show_store&id=<?php echo $v['store_id']?>"><?php echo $v['store_name'];?></a></td>
