  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=type&op=export_step1"><span><?php echo $lang['nc_export'];?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w48 sort"><span class="tooltip editable" title="<?php echo $lang['nc_editable'];?>" maxvalue="255" datatype="pint" fieldid="<?php echo $val['type_id'];?>" ajax_branch="sort" fieldname="type_sort" nc_type="inline_edit"><?php echo $val['type_sort'];?></span></td>
          <td class="name"><span><?php echo $val['type_name'];?></span></td>
          <td class="w150"><a href="index.php?act=type&op=type_edit&t_id=<?php echo $val['type_id'];?>"><?php echo $lang['nc_edit'];?></a> | <a onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=type&op=type_del&del_id=<?php echo $val['type_id'];?>';}else{return false;}" href="javascript:void(0)"><?php echo $lang['nc_del'];?></a></td>
        </tr>
        <?php }?>
        <?php }else{ ?>
        <tr class="no_data">
