  ...
  <form id="grade_form" method="post">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <!--<tr><td colspan="2" class="required"><label> <?php echo $lang['upload_space_size'];?>(MB):</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="" id="sg_space_limit" name="sg_space_limit" class="txt">
			<label class="field_notice"><?php echo $lang['zero_said_no_limit'];?></label>      </td>
		</tr>-->
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><ul class="nofloat">
              ...
              <!--<li><input type="checkbox" id="function_coupon" value="coupon" name="sg_function[]"><label for="function_coupon">&nbsp;<?php echo $lang[''];?></label></li>-->
              <!--
              <li>
                <input type="checkbox" id="function_groupbuy" value="groupbuy" name="sg_function[]">
                <label for="function_groupbuy"><?php echo $lang['groupbuy_active'];?></label>
              </li>
              -->
            </ul></td>
        </tr>
        ...
        <tr>
          <td colspan="2" class="required"><label><?php echo $lang['need_audit'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="sg_confirm1" class="cb-enable selected" ><span><?php echo $lang['nc_yes'];?></span></label>
            <label for="sg_confirm0" class="cb-disable " ><span><?php echo $lang['nc_no'];?></span></label>
          ...
          <td class="vatop tips"><?php echo $lang['need_audit_notice'];?></td>
        </tr>
        <tr>
