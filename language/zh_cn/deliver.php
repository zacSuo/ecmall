...
$lang['store_daddress_phone_num']		= '电话号码';
...
$lang['store_daddress_phone_and_mobile']	= '固定电话和手机请至少填写一项.';
$lang['store_daddress_phone_rule']		= '电话号码由数字、加号、减号、空格、括号组成,并不能少于6位. ';
$lang['store_daddress_wrong_mobile']	= '错误的手机号码,只能是数字,并且不能少于6位. ';
...
$lang['store_deliver_buyer_address']		= '收货信息';
$lang['store_deliver_shipping_sel']			= '运输选择';
$lang['store_deliver_modify_info']			= '编辑发货信息';
...
$lang['store_deliver_buyer_adress']			= '买家收货信息';
$lang['store_deliver_confirm_daddress']		= '确认发货信息';
$lang['store_deliver_my_daddress']			= '我的发货信息';
$lang['store_deliver_none_set']				= '还未设置';
$lang['store_deliver_add_daddress']			= '添加发货地址';
$lang['store_deliver_express_select']		= '选择物流服务';
$lang['store_deliver_express_note']			= '您可以通过"发货设置-><a href="index.php?act=deliver&op=express" target="_parent" >默认物流公司</a>"添加或修改常用货运物流。免运或自提商品可切换下方<span class="red">[无需物流运输服务]</span>选项卡并操作。';
...
$lang['store_deliver_no_deliver_tips']		= '如果订单中的商品无需物流运送(如线下交易或虚拟物品)，您可以直接确认提交';
...
$lang['store_deliver_post']			= '邮编';
$lang['store_deliver_telphone']		= '座机';
$lang['store_deliver_mobphone']		= '手机';
