  ...
  <form id="link_form" enctype="multipart/form-data" method="post" name="form1">
    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" for="ap_price"><?php echo $lang['ap_price_name'];?>:</label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $v['ap_price'];?>" name="ap_price" class="txt" id='ap_price'></td>
          <td class="vatop tips"><?php echo $lang['ap_price_unit'];?></td>
        </tr>
      </tbody>
      <?php }?>
      <tfoot>
