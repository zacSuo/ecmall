  ...
  <form id="form_add" method="post">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" for="width"><?php echo $lang['recommend_add_width'];?></label>-<label for="height"><?php echo $lang['recommend_add_height'];?></label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['config_array']['width'];?>" name="width" id="width" class="txt2">-&nbsp;&nbsp;<input type="text" value="<?php echo $output['config_array']['height'];?>" name="height" id="height" class="txt2"></td>
