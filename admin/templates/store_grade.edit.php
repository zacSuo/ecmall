  ...
  <form id="grade_form" method="post">
    ...
    <table class="table tb-type2 nobdb">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="sg_confirm1" class="cb-enable <?php if($output['grade_array']['sg_confirm'] == '1'){ ?>selected<?php } ?>" ><span><?php echo $lang['nc_yes'];?></span></label>
            <label for="sg_confirm0" class="cb-disable <?php if($output['grade_array']['sg_confirm'] == '0'){ ?>selected<?php } ?>" ><span><?php echo $lang['nc_no'];?></span></label>
            <input id="sg_confirm1" name="sg_confirm" <?php if($output['grade_array']['sg_confirm'] == '1'){ ?>checked="checked"<?php } ?>  value="1" type="radio">
            <input id="sg_confirm0" name="sg_confirm" <?php if($output['grade_array']['sg_confirm'] == '0'){ ?>checked="checked"<?php } ?> value="0" type="radio"></td>
