  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['store_verify'];?></span></a></li>
      </ul>
    </div>
  </div>
  ...
  <form id="store_form" method="post">
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr>
          <td colspan="2" class="required"><label>
            <label for="state"><?php echo $lang['store_verify'];?>:</label>
            </label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="store_state1" class="cb-enable selected" ><span><?php echo $lang['store_pass'];?></span></label>
            <label for="store_state0" class="cb-disable" ><span><?php echo $lang['store_no_pass'];?></span></label>
      ...
      <tbody id="tr_store_close_info" style="display:none">
        <tr >
          <td colspan="2" class="required"><label for="store_close_info"><?php echo $lang['store_not_by_reason'];?>:</label></td>
        </tr>
        <tr class="noborder">
