...
<div class="commend-goods-list">
    <ul id="pinterest">
        ...
        <?php } ?>
        <?php } ?>
        <div class="picture"> <a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=goods&op=detail&goods_id=<?php echo $value['commend_id'];?>" target="_blank">
                <?php $image_url = cthumb($value['commend_goods_image'],'240x240',$value['commend_goods_store_id']);?>
                <?php list($width, $height, $type, $attr) = getimagesize($image_url);?>
                <?php if($width > 240) {$height = $height*240/$width;$width=240;} ?>
                <img class="lazy" height="<?php echo $height;?>" width="<?php echo $width;?>" src="<?php echo MICROSHOP_TEMPLATES_PATH;?>/images/loading.gif" data-src="<?php echo $image_url;?>" title="<?php echo $value['commend_goods_name'];?>" alt="<?php echo $value['commend_goods_name'];?>" /> </a>
        ...
        <div class="handle">
            ...
            <span class="comment"><a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=goods&op=detail&goods_id=<?php echo $value['commend_id'];?>" target="_blank"><i title="<?php echo $lang['microshop_comment'];?>" class="pngFix">&nbsp;</i><em><?php echo $value['comment_count']<=999?$value['comment_count']:'999+';?></em></a></span>
        </div>
        <dl class="commentary">
            ...
            <p> <a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=goods&op=detail&goods_id=<?php echo $value['commend_id'];?>" target="_blank"> <?php echo $value['commend_message'];?> </a> </p>
            </dd>
        </dl>
        </li>
        <?php } ?>
...
<div class="no-content"> <i class="goods pngFix"></i>
    ...
    <?php } else { ?>
        ...
        <?php } else { ?>
            ...
            <a href="<?php echo MICROSHOP_SITEURL.'/index.php?act=publish&op=goods_buy';?>"><?php echo $lang['microshop_goods_publish'];?></a>
            <?php } else { ?>
