...
<div id="div_sns_share" style="display:none;">
    <form action="<?php echo MICROSHOP_SITEURL;?>/index.php?act=share&op=share_save&type=<?php echo $_GET['act'];?>" method="post" id="share_form" class="feededitor">
        ...
        <div class="command-goods">
            <div class="pic">
                <span class="thumb size100">
                    <i></i>
                <?php $image_url = cthumb($output['detail']['commend_goods_image'],'tiny',$output['detail']['commend_goods_store_id']);?>
        ...
        <div class="command-goods">
            <div class="pic">
                <span class="thumb size100">
                    <i></i>
                    <?php $personal_image_array = getPersonalImageUrl($output['detail'],'tiny');?>
