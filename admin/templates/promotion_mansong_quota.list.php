      ...
      <tbody>
        <tr>
          ...
          <td><select name="state">
                  <?php if(is_array($output['mansong_quota_state_list'])) { ?>
                  <?php foreach($output['mansong_quota_state_list'] as $key=>$val) { ?>
    ...
    <tbody>
      ...
      <tr>
        <td><ul>
            ...
            <li><?php echo $lang['mansong_quota_list_help2'];?></li>
          </ul></td>
      </tr>
    </tbody>
  </table>
  ...
  <form id="list_form" method="post">
    ...
    <table class="table tb-type2">
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
            <td><input type="checkbox" name='mansong_quota_checkbox' value="<?php echo $val['quota_id'];?>" class="checkitem"></td>
            ...
            <td class="align-center"><span><?php echo $output['mansong_quota_state_list'][$val['state']];?></span></td>
            <td class="nowrap align-center">
                <!-- 取消按钮 --> 
                <?php if(intval($val['state']) === intval($output['mansong_quota_state_activity'])) { ?>
