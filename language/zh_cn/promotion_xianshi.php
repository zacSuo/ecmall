...
$lang['xianshi_manage_goods_explain1'] = '每件商品在每期限时折扣套餐中只能参加一个活动，已参加其它活动的商品在选择列表将被标志为已参加';
$lang['xianshi_manage_goods_explain2'] = '手工取消的商品可以再参加其它活动';
$lang['xianshi_price_explain1'] = '购买单位为月(30天)，一次最多购买12个月，您可以在所购买周期内以月为单位发布限时折扣活动';
$lang['xianshi_price_explain2'] = '每月您需要支付';
$lang['xianshi_price_explain3_1'] = '每月发布活动没有次数限制';
$lang['xianshi_price_explain3_2'] = '每月最多发布活动';
$lang['xianshi_price_explain4_1'] = '每次活动没有商品数量限制';
$lang['xianshi_price_explain4_2'] = '每次活动最多发布';
$lang['xianshi_price_explain5'] = '套餐时间从审批后开始计算';
...
$lang['xianshi_name_explain'] = '活动名称最多为25个字符';
