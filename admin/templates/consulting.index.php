      ...
      <tbody>
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search tooltip" title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a class="btns tooltip" href="index.php?act=consulting&op=consulting" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?>
        </tr>
      </tbody>
    </table>
      ...
      <tbody>
        ...
        <tr class="space">
          ...
          <th>
          	...
          	<span><a target="_blank" href="<?php echo SiteUrl."/index.php?act=goods&goods_id=".$consult['goods_id'].'&id='.$consult['store_id'];?>"><?php echo $consult['cgoods_name'];?></a></span>
          </th>
          <th><strong><?php echo $lang['consulting_index_store_name'];?>:</strong>&nbsp;<a href="<?php echo SiteUrl."/index.php?act=show_store&id=".$consult['store_id'];?>" target="_blank" class="normal" ><?php echo $consult['store_name'];?></a></th>
