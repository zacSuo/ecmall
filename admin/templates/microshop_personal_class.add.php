...
<div class="page">
  ...
  <form id="add_form" method="post" enctype="multipart/form-data" action="index.php?act=microshop&op=personal_class_save">
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"> <img class="show_image" src="<?php echo TEMPLATES_PATH;?>/images/preview.png">
            <div class="type-file-preview">
              ...
              <img src="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.'default_goods_class_image.gif';?>">
              <?php } else { ?>
              <img src="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.$output['class_info']['class_image'];?>">
              <?php } ?>
            </div>
