...
<div class="commend-class">
  <ul class="commend-class-root pngFix">
   ...
   <a href="index.php?act=goods&goods_class_root_id=<?php echo $val['class_id'];?>" class="pngFix">
      ...
      <div class="picture"><img src="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.$val['class_image'];?>" class="pngFix" alt="" onload="javascript:DrawImage(this,30,30);"/></div>
  ...
  <ul class="commend-class-menu">
    ...
    <li>
      <div class="commend-class-menu-img"><span class="thumb size60"><i></i>
        <?php if(empty($val['class_image'])) $val['class_image'] = 'default_goods_class_image.gif' ?>
        <a <?php if($output['goods_class_menu_id'] == $val['class_id']) echo "class='selected'";?> href="index.php?act=goods&goods_class_root_id=<?php echo $output['goods_class_root_id'];?>&goods_class_menu_id=<?php echo $val['class_id'];?>"> <img src="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.$val['class_image'];?>" alt=""  onload="javascript:DrawImage(this,60,60);"/> </a></span> </div>
