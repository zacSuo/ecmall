...
//网站地址，最后不要斜杠
$config['site_url'] = 'http://suoxd.name';

//版本号
$config['version'] = '20130705';

//安装日期
$config['setup_date'] = '2015-02-16 08:52:55';
...
$config['db'][1]['dbhost']  	= 'hdm-131.hichina.com';
$config['db'][1]['dbport']		= '3306';
$config['db'][1]['dbuser']  	= 'hdm1310898';
$config['db'][1]['dbpwd'] 	 	= 'stayfoolish';
$config['db'][1]['dbname']  	= 'hdm1310898_db';                  //在设置主从服务器部署或者使用pdo时，该项均必须填写正确且所有服务器的数据库名须与此设置相同！
$config['db'][1]['dbcharset']   = 'UTF-8';
