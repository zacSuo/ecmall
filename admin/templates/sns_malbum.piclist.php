        ...
        <?php if(!empty($output['pic_list'])){ ?>
          ...
          <li class="picture">
            <div class="size-64x64">
              <span class="thumb">
                <i></i><img width="64" height="64" class="show_image" src="<?php echo SiteUrl.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['ap_cover'].'_240x240.'.get_image_type($val['ap_cover']);?>" />
                <span class="type-file-preview" style="display: none;">
                  <img src="<?php echo SiteUrl.DS.ATTACH_MALBUM.DS.$val['member_id'].DS.$val['ap_cover'].'_240x240.'.get_image_type($val['ap_cover']);?>">
                </span>
              </span>
            </div>
            <p>
      ...
      <tfoot>
        <tr class="tfoot">
          ...
          <td colspan="16">
            ...
            <a class="btn" href="javascript:void(0);" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){$('#form_pic').submit();}"><span><?php echo $lang['nc_delete'];?></span></a>
