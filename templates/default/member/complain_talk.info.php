...
<?php } ?>
<form action="index.php?act=<?php echo $_GET['act'];?>&op=apply_handle" method="post" id="handle_form">
...
function get_complain_talk() {
    ...
    $.ajax({
        type:'POST',
        url:'index.php?act=<?php echo $_GET['act'];?>&op=get_complain_talk',
        cache:false,
...
function publish_complain_talk() {
        $.ajax({
            type:'POST',
                url:'index.php?act=<?php echo $_GET['act'];?>&op=publish_complain_talk',
                cache:false,
