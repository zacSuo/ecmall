    ...
    <table class="tb-type1 noborder search">
      <tbody>
        <tr>
          ...
          <td><input type="text" value="<?php echo $output['bundling_name'];?>" name="bundling_name" id="bundling_name" class="txt" style="width:100px;"></td>
          <th><label for="store_name"><?php echo $lang['bundling_quota_store_name'];?></label></th>
          <td><input type="text" value="<?php echo $output['store_name'];?>" name="store_name" id="store_name" class="txt" style="width:100px;"></td>
      ...
      <tbody id="treet1">
        ...
        <tr class="hover">
          ...
          <td class="align-center yes-onoff">
            <a href="JavaScript:void(0);" class="tooltip <?php echo $val['bl_state']? 'enabled':'disabled';?>" ajax_branch="bl_state" nc_type="inline_edit"  fieldname="bl_state" fieldid="<?php echo $val['bl_id'];?>" fieldvalue="<?php  echo $val['bl_state'] ? '1' : '0';?>" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo TEMPLATES_PATH;?>/images/transparent.gif"></a>
          </td>
          <td class="nowrap align-center">
          	<a target="block" href="<?php echo SiteUrl;?>/index.php?act=bundling&bundling_id=<?php echo $val['bl_id'];?>&id=<?php echo $val['store_id'];?>"><?php echo $lang['nc_view'];?></a>
          </td>
        </tr>
        <?php } ?>
        <?php }else { ?>
