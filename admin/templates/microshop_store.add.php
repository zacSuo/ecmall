        ...
        <table class="table tb-type2">
            <thead>
                <tr class="thead">
                    ...
                    <th class="w72"><?php echo $lang['microshop_store_goods_count'];?></th>
                    <th class="w72"><?php echo $lang['microshop_store_credit'];?></th>
                    <th class="w48"><?php echo $lang['microshop_store_praise_rate'];?></th>
            ...
            <tbody>
                ...
                <tr class="hover edit">
                    ...
                    <td>
                        <?php if($store_exist) {?>
                        <input type="checkbox" value="<?php echo $value['store_id'];?>" class="checkitem" disabled>
                        <?php } else { ?>
                        <input type="checkbox" value="<?php echo $value['store_id'];?>" class="checkitem">
                        <?php } ?>
                    </td>
                    <td>
                        <a href="<?php echo SiteUrl;?>/index.php?act=show_store&id=<?php echo $value['store_id']?>" target="_blank">
                    ...
                    <td><?php echo $value['goods_count'];?></td>
                    <td><?php echo $value['store_credit'];?></td>
                    <td><?php echo $value['praise_rate'];?>%</td>
                    <td>
                        <?php if($store_exist) {?>
            ...
            <tfoot>
                <tr class="tfoot">
                    ...
                    <td colspan="16">
                        ...
                        &nbsp;&nbsp;<a href="JavaScript:void(0);" class="btn" onclick="submit_batch();"><span><?php echo $lang['nc_add'];?></span></a>
