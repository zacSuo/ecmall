...
<div class="wrap">
  ...
  <table class="ncu-table-style">
    <thead>
      <tr>
        <th class="w150"><?php echo $lang['return_order_ordersn'];?></th>
        <th class="w150"><?php echo $lang['return_order_returnsn'];?></th>
        ...
        <th class="w50"><?php echo $lang['return_state'];?></th>
    ...
    <tbody>
      ...
      <tr class="bd-line" >
        ...
        <td><a href="index.php?act=show_store&id=<?php echo $val['store_id']; ?>" target="_blank" title="<?php echo $val['store_name']; ?>"><?php echo $val['store_name']; ?></a></td>
        <td><strong><?php echo $val['return_goodsnum'];?></strong></td>
        <td class="goods-time"><?php echo date("Y-m-d H:i:s",$val['add_time']);?></td>
        <td><?php echo $output['state_array'][$val['return_state']]; ?></td>
        <td><a href="javascript:void(0)" nc_type="dialog" dialog_title="<?php echo $lang['nc_view'];?>" dialog_id="return_order" dialog_width="480" uri="index.php?act=member_return&op=view&return_id=<?php echo $val['return_id']; ?>"> <?php echo $lang['nc_view'];?> </a></td>
      </tr>
      <?php } ?>
      <?php } else { ?>
      <tr>
