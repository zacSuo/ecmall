      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="w150 align-center"><?php if($v['admin_is_super']){?>
            ...
            <?php }else{?>
            <a href="index.php?act=admin&op=admin_set&admin_id=<?php echo $v['admin_id'];?>"><?php echo $lang['admin_index_edit_right'];?></a> | <a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['nc_ensure_del'];?>')){location.href='index.php?act=admin&op=admin_del&admin_id=<?php echo $v['admin_id']; ?>'}"><?php echo $lang['admin_index_del_admin'];?></a> | <a href="index.php?act=admin&op=admin_edit&admin_id=<?php echo $v['admin_id']; ?>"><?php echo $lang['nc_edit'];?></a>
            <?php }?></td>
        </tr>
        <?php } ?>
        <?php }else { ?>
