...
$(document).ready(function(){
    ...
    $("#btn_sns_addfollow").live('click',function(){
        $.getJSON("<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=home&op=add_follow&member_id=<?php echo $output['member_info']['member_id'];?>", {}, function(json){
            if(json.result == "true") {
	...
	$("#btn_sns_delfollow").live('click',function(){
        $.getJSON("<?php echo MICROSHOP_SITEURL.DS;?>index.php?act=home&op=del_follow&member_id=<?php echo $output['member_info']['member_id'];?>", {}, function(json){
            if(json.result == "true") {
  ...
  <div class="user-info-box">
    ...
    <dl class="user-intro">
      <dt>
        ...
        <h4><?php echo $lang['microshop_text_buyer_credit'].$lang['nc_colon'];?>
          <?php if (empty($output['member_info']['credit_arr'])){ echo '<span>- '.$lang['microshop_text_no_credit'].'</span>'; }else {?>
...
<div class="user-page-nav">
  <ul>
    <li <?php echo $output['home_sign'] == 'goods'?'class="current"':'class="link"'; ?>><a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=home&op=goods&member_id=<?php echo $output['member_info']['member_id'];?>" class="pngFix"><i class="link2 pngFix"></i><span><?php echo $lang['nc_microshop_goods'];?></span></a></li>
    <!--
        <li <?php echo $output['home_sign'] == 'album'?'class="current"':'class="link"'; ?>><a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=home&op=album&member_id=<?php echo $output['member_info']['member_id'];?>"><i class="link3"></i><span><?php echo $lang['nc_microshop_album'];?></span></a></li>
        -->
    <li <?php echo $output['home_sign'] == 'personal'?'class="current pngFix"':'class="link pngFix"'; ?>><a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=home&op=personal&member_id=<?php echo $output['member_info']['member_id'];?>" class="pngFix"><i class="link4 pngFix"></i><span><?php echo $lang['nc_microshop_personal'];?></span></a></li>
    <li <?php echo $output['home_sign'] == 'like'?'class="current pngFix"':'class="link pngFix"'; ?>><a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=home&op=like_list&member_id=<?php echo $output['member_info']['member_id'];?>" class="pngFix"><i class="link5 pngFix"></i><span><?php echo $lang['nc_microshop_like'];?></span></a></li>
  </ul>
</div>
<?php 
