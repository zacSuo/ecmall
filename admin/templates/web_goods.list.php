...
<ul class="dialog-goodslist-s2">
  ...
  <li>
    <div onclick="select_recommend_goods(<?php echo $v['goods_id'];?>);" class="goods-pic"><span class="ac-ico"></span><span class="thumb size-72x72"><i></i><img goods_id="<?php echo $v['goods_id'];?>" store_id="<?php echo $v['store_id'];?>" goods_price="<?php echo $v['goods_store_price'];?>" title="<?php echo $v['goods_name'];?>" src="<?php echo thumb($v,'small');?>" onload="javascript:DrawImage(this,72,72);" /></span></div>
