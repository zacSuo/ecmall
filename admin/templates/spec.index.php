  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="index.php?act=spec&op=export_step1"><span><?php echo $lang['nc_export'];?></span></a></li>
      </ul>
    </div>
  </div>
    ...
    <table class="table tb-type2">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="w48 sort"><span class="tooltip editable" title="<?php echo $lang['nc_editable'];?>" maxvalue="255" datatype="pint" fieldid="<?php echo $val['sp_id'];?>" ajax_branch="sort" fieldname="sp_sort" nc_type="inline_edit"><?php echo $val['sp_sort'];?></span></td>
          <td class="w270 name"><span><?php echo $val['sp_name'];?></span></td>
          <td class="name"><?php echo $val['sp_value']?></td>
