    ...
    <table class="table tb-type2 nobdb">
      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="name w270"><span nc_type="inline_edit" fieldname="brand_name" ajax_branch='brand_name' fieldid="<?php echo $v['brand_id']?>" required="1" class="editable" title="<?php echo $lang['nc_editable'];?>"><?php echo $v['brand_name']?></span></td>
          <td class="class"><span nc_type="inline_edit" fieldname="brand_class" ajax_branch='brand_class' fieldid="<?php echo $v['brand_id']?>" required="1" class="editable" title="<?php echo $lang['nc_editable'];?>"><?php echo $v['brand_class']?></span></td>
          <td><div class="brand-picture"><span class="thumb size-brand"><i></i><img src="<?php if(!empty($v['brand_pic'])){ echo SiteUrl.'/'.ATTACH_BRAND.'/'.$v['brand_pic'];}else{ echo SiteUrl.'/templates/'.TPL_NAME.'/images/default_brand_image.gif';}?>" onload="javascript:DrawImage(this,88,44);" /></span></div></td>
