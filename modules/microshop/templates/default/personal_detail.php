...
<div class="commend-goods">
  <div class="commend-goods-info">
    <div class="user">
      ...
      <dl>
        <dt> <a href="<?php echo MICROSHOP_SITEURL;?>/index.php?act=home&member_id=<?php echo $output['detail']['commend_member_id'];?>" target="_blank"> <?php echo $output['detail']['member_name'];?></a><?php echo $lang['microshop_personal_commend'];?><span class="add-time"><?php echo date('Y-m-d',$output['detail']['commend_time']);?></span></dt>
        <dd><i></i>
    ...
    <div class="goods">
      ...
      <?php $personal_image_array = getPersonalImageUrl($output['detail']);?>
      <?php if(!empty($personal_image_array)) { ?>
      <?php foreach($personal_image_array as $val) { ?>
      <div class="pic"> <img class="lazy" src="<?php echo MICROSHOP_TEMPLATES_PATH;?>/images/loading.gif" data-src="<?php echo $val;?>" /> </div>
      <?php } ?>
      <?php } ?>
