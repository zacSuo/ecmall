      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <td class="fd-list"><!-- 动态列表start -->
            ...
            <li>
              <div class="fd-aside"> <span class="thumb size60"><a href="<?php echo SiteUrl.DS;?>index.php?act=member_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank"> <img src="<?php if ($v['trace_memberavatar']!='') { echo SiteUrl.DS.ATTACH_AVATAR.DS.$v['trace_memberavatar']; } else {  echo SiteUrl.DS.ATTACH_COMMON.DS.C('default_user_portrait'); } ?>" onload="javascript:DrawImage(this,60,60);"> </a> </span> </div>
              <dl class="fd-wrap">
                <dt>
                  <h3><a href="<?php echo SiteUrl.DS;?>index.php?act=member_snshome&mid=<?php echo $v['trace_memberid'];?>" target="_blank"><?php echo $v['trace_membername'];?></a><?php echo $lang['nc_colon'];?></h3>
