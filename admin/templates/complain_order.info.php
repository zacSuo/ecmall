...
<table class="table tb-type2 order">
  <thead class="thead">
    ...
    <tbody>
    <tr>
      <th><?php echo $lang['order_message'];?></th>
    </tr>
    <tr class="noborder">
      <td><ul>
          <li><strong><?php echo $lang['order_state'];?>:</strong><b><?php echo $output['order_info']['order_state_text'];?></b></li>
          <li><strong><?php echo $lang['order_sn'];?>:</strong><a href="index.php?act=trade&op=show_order&order_id=<?php echo $output['order_info']['order_id'];?>" target="_blank"><?php echo $output['order_info']['order_sn'];?></a> </li>
          <li><strong><?php echo $lang['order_datetime'];?>:</strong><?php echo date('Y-m-d H:i:s',$output['order_info']['add_time']);?></li>
          <li><strong><?php echo $lang['order_price'];?>:</strong><?php echo $lang['currency'].$output['order_info']['order_amount'];?></li>
    ...
    <tr>
      <th><?php echo $lang['order_seller_message'];?></th>
    </tr>
    <tr class="noborder">
      <td><ul>
          <li><strong><?php echo $lang['order_shop_name'];?>:</strong><a href="<?php echo SiteUrl;?>/index.php?act=show_store&id=<?php echo $output['order_info']['store_id'];?>" target="_blank"> <?php echo $output['order_info']['store_name'];?> </a> </li>
        </ul></td>
    </tr>
    <tr>
      <th><?php echo $lang['order_buyer_message'];?></th>
    </tr>
    <tr class="noborder">
      <td><ul>
          <li><strong><?php echo $lang['order_buyer_name'];?>:</strong><?php echo $output['order_info']['buyer_name'];?></li>
        </ul></td>
    </tr>
  </tbody>
</table>
