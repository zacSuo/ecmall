...
class goodsControl extends MircroShopControl{
    ...
    public function detailOp() {
        ...
        $store_info = $model_store->getOne($detail['commend_goods_store_id']);
        $store_info_array = $model_store->getStoreSearchList(array($store_info));
        $store_info = $store_info_array[0];
