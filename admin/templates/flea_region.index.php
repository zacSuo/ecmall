  ...
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        ...
        <li><a href="javascript:void(0)" onclick="if(confirm('<?php echo $lang['region_index_import_tip'];?>?')){location.href='index.php?act=flea_region&op=flea_import_default_area';}"><span><?php echo $lang['region_index_import_region'];?></span></a></li>
      </ul>
    </div>
  </div>
