      ...
      <tbody>
        ...
        <tr class="hover edit">
          <td class="w36"><input type="checkbox" name='check_sc_id[]' value="<?php echo $v['sc_id'];?>" class="checkitem">
            ...
            <img fieldid="<?php echo $v['sc_id'];?>" status="open" nc_type="flex" src="<?php echo TEMPLATES_PATH;?>/images/tv-expandable.gif">
            <?php }else{ ?>
            <img fieldid="<?php echo $v['sc_id'];?>" status="close" nc_type="flex" src="<?php echo TEMPLATES_PATH;?>/images/tv-item.gif">
            <?php } ?></td>
...
<script type="text/javascript" src="<?php echo RESOURCE_PATH;?>/js/jquery.store_class.js" charset="utf-8"></script> 