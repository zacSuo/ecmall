<div class="eject_con">
  <div id="warning"></div>
  <form method="post" id="order_cancel_form" onsubmit="ajaxpost('order_cancel_form', '', '', 'onerror');return false;" action="index.php?act=store&op=change_state&state_type=store_order_cancel&order_id=<?php echo $output['order_id']; ?>">
    <input type="hidden" name="form_submit" value="ok" />
    <h2><?php echo $lang['store_order_ensure_cancel'];?></h2>
    <dl>
    ...
    <dl>
      ...
      <dd>
        <ul class="checked">
          ...
          <li>
            <input type="radio" name="state_info" flag="other_reason" id="d4" value="<?php echo $lang['store_order_other_reason'];?>" />
