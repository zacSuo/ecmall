...
<div class="page">
  <div class="fixed-bar">
    <div class="item-title">
      ...
      <ul class="tab-base">
        <li><a href="JavaScript:void(0);" class="current"><span><?php echo $lang['mailtemplates_index_mail'];?></span></a></li>
      ...
      <tbody>
        ...
        <tr class="hover">
          ...
          <td class="align-center power-onoff"><?php if($v['mail_switch'] == '0'){ ?>
            ...
            <?php } ?></td>
          <td class="w60 align-center"><a href="index.php?act=mailtemplates&op=mailtemplates_edit&code=<?php echo $v['code']; ?>"><?php echo $lang['nc_edit'];?></a></td>
        </tr>
        <?php } ?>
        <?php } ?>
      </tbody>
