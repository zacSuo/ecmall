      ...
      <tbody>
        ...
        <tr class="hover edit">
          ...
          <?php if($v['aclass_cover'] != ''){ ?>
              <img src="<?php echo cthumb($v['aclass_cover'],'small',$v['store_id']);?>" onload="javascript:DrawImage(this,70,70);">
              <?php }else{?>
              <img src="<?php echo SiteUrl.'/templates/'.TPL_NAME.'/images/member/default_image.png';?>" onload="javascript:DrawImage(this,70,70);">
              <?php }?>
          </td>
          <td class="name"><?php echo $v['aclass_name'];?></td>
          <td class="class"><a href="../index.php?act=show_store&id=<?php echo $v['store_id'];?>" target="_blank"><?php echo $v['store_name'];?></td>
