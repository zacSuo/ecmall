      ...
      <tbody>
        ...
        <tr>
          ...
          <td><a href="javascript:document.formSearch.submit();" class="btn-search tooltip" title="<?php echo $lang['nc_query'];?>">&nbsp;</a>
            ...
            <a class="btns tooltip" href="index.php?act=complain&op=<?php echo $output['op'];?>" title="<?php echo $lang['nc_cancel_search'];?>"><span><?php echo $lang['nc_cancel_search'];?></span></a>
            <?php }?></td>
        </tr>
      </tbody>
    </table>
