...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='闲置商品';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='闲置地区';
...
CREATE TABLE `shopnc_flea_class` (
  ...
  PRIMARY KEY  (`gc_id`)
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='闲置分类';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='闲置首页分类';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='闲置咨询';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='闲置上传文件表';
...
) ENGINE=MyISAM  DEFAULT CHARSET=gbk COMMENT='买家闲置收藏表';
