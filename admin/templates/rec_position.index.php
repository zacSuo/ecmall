        ...
        <tr class="hover edit">
          ...
          <td class="picture"><?php 
				if($v['pic_type'] == 0){
					...
					echo "<a target='_blank' href='".str_replace('SiteUrl',SiteUrl,$v['content']['body'][0]['title'])."'><img width=\"88\" height=\"31\" src='".str_replace('SiteUrl',SiteUrl,$v['content']['body'][0]['title'])."' onload='javascript:DrawImage(this,88,31);' /></a>";
				}
				?></td>
