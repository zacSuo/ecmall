      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform onoff">
          	<label for="microshop_isuse_1" class="cb-enable <?php if($output['setting']['microshop_isuse'] == '1'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_open'];?>"><span><?php echo $lang['nc_open'];?></span></label>
            <label for="microshop_isuse_0" class="cb-disable <?php if($output['setting']['microshop_isuse'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_close'];?>"><span><?php echo $lang['nc_close'];?></span></label>
            <input type="radio" id="microshop_isuse_1" name="microshop_isuse" value="1" <?php echo $output['setting']['microshop_isuse']==1?'checked=checked':''; ?>>
            <input type="radio" id="microshop_isuse_0" name="microshop_isuse" value="0" <?php echo $output['setting']['microshop_isuse']==0?'checked=checked':''; ?>></td>
          <td class="vatop tips"><?php echo $lang['microshop_isuse_explain'];?></td>
        </tr>
        <tr class="noborder">
          <td colspan="2" class="required"><label for="microshop_url"><?php echo $lang['microshop_url'].$lang['nc_colon'];?></label></td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><input type="text" value="<?php echo $output['setting']['microshop_url'];?>" name="microshop_url" class="txt"></td>
          <td class="vatop tips"><?php echo $lang['microshop_url_explain'];?></td>
        </tr>
        <tr>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"> <img class="show_image" src="<?php echo TEMPLATES_PATH;?>/images/preview.png">
            <div class="type-file-preview">
              ...
              <img src="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.'default_logo_image.png';?>">
              <?php } else { ?>
              <img src="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.$output['setting']['microshop_logo'];?>">
              <?php } ?>
            </div>
        ...
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show"> <img class="show_image" src="<?php echo TEMPLATES_PATH;?>/images/preview.png">
            <div class="type-file-preview">
              ...
              <img src="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.'default_header_pic_image.png';?>">
              <?php } else { ?>
              <img src="<?php echo SiteUrl.DS.ATTACH_MICROSHOP.DS.$output['setting']['microshop_header_pic'];?>">
              <?php } ?>
            </div>
            </span> <span class="type-file-box">
