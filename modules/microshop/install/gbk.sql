...
CREATE TABLE `shopnc_micro_adv` (
  ...
  PRIMARY KEY (`adv_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=gbk COMMENT='微商城广告表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=gbk COMMENT='微商城商品评论表';
...
CREATE TABLE `shopnc_micro_goods` (
  ...
  `commend_goods_image_more` text NOT NULL COMMENT '推荐商品更多图片',
...
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=gbk COMMENT='微商城推荐商品表(随心看)';
...
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=gbk COMMENT='微商城商品(随心看)分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=gbk COMMENT='微商城商品分类和商城商品分类对应关系';
...
CREATE TABLE `shopnc_micro_like` (
  ...
  PRIMARY KEY (`like_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=gbk COMMENT='微商城喜欢表';
...
) ENGINE=MyISAM DEFAULT CHARSET=gbk COMMENT='微商城用户信息表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=gbk COMMENT='微商城个人秀表';
...
CREATE TABLE `shopnc_micro_personal_class` (
  ...
  `class_image` varchar(100) NOT NULL DEFAULT '' COMMENT '分类图片',
  PRIMARY KEY (`class_id`)
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=gbk COMMENT='微商城个人秀分类表';
...
) ENGINE=MyISAM AUTO_INCREMENT=1 DEFAULT CHARSET=gbk COMMENT='微商城店铺街表';
