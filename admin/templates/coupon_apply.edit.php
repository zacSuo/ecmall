...
<div class="page">
  ...
  <form id="add_form" method="post" name="form1">
    ...
    <table class="table tb-type2">
      <tbody>
        <tr class="noborder">
          <td colspan="2"><?php echo $lang['coupon_name'];?>: </td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2"><?php echo $lang['coupon_price'];?>:
            </td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2"><?php echo $lang['coupon_store_name'];?>: </td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2"><?php echo $lang['coupon_class'];?>: </td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2"><?php echo $lang['coupon_lifetime'];?>: </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><?php echo date('Y-m-d',$output['coupon']['coupon_start_date']); ?>
            ~
            <?php echo date('Y-m-d',$output['coupon']['coupon_end_date']) ; ?></td>
          <td class="vatop tips"></td>
        </tr>
        <tr>
          <td colspan="2"><?php echo $lang['coupon_pic'];?>:
            </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><span class="type-file-show" style=" float:left;"><img src="<?php if(stripos($output['coupon']['coupon_pic'] ,'http://') === false ){ echo SiteUrl.'/'.$output['coupon']['coupon_pic'];  }else{ echo $output['coupon']['coupon_pic'];  }?>" onload="javascript:DrawImage(this,320,145);" onerror="this.src='<?php echo TEMPLATES_PATH;?>/images/default_coupon_image.png'" />
        ...
        <tr>
          <td colspan="2"><?php echo $lang['coupon_notice'];?>: </td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2"><?php echo $lang['coupon_state'];?>:
            </td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2"><?php echo $lang['nc_recommend'];?>:
            </td>
        </tr>
        <tr class="noborder">
        ...
        <tr>
          <td colspan="2"><?php echo $lang['nc_pass'];?>:
            </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform onoff"><label for="allowstate1" class="cb-enable <?php if($output['coupon']['coupon_allowstate'] == '0'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_yes'];?>"><span><?php echo $lang['nc_yes'];?></span></label>
            <label for="allowstate2" class="cb-disable <?php if($output['coupon']['coupon_allowstate'] == '2'){ ?>selected<?php } ?>" title="<?php echo $lang['nc_no'];?>"><span><?php echo $lang['nc_no'];?></span></label>
            <input id="allowstate1" name="coupon_allowstate" <?php if($output['coupon']['coupon_allowstate'] == '0'){ ?>checked="checked"<?php } ?> value="1" type="radio">
            <input id="allowstate2" name="coupon_allowstate" <?php if($output['coupon']['coupon_allowstate'] == '2'){ ?>checked="checked"<?php } ?>  value="2" type="radio"></td>
          <td class="vatop tips"><?php echo $lang['coupon_allow_tips'];?></td>
        </tr>
        <tr>
          <td colspan="2"><?php echo $lang['coupon_allow_remark'];?>:
            </td>
        </tr>
        <tr class="noborder">
          <td class="vatop rowform"><textarea name="coupon_allowremark" id="coupon_allowremark" class="text" ><?php echo $output['coupon']['coupon_allowremark']; ?></textarea></td>
          <td class="vatop tips"><?php echo $lang['coupon_remark_tips'];?></td>
        </tr>
      </tbody>
      <tfoot>
