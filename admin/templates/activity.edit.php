  ...
  <form id="add_form" method="post" enctype="multipart/form-data">
    ...
    <table class="table tb-type2">
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform">
          	<span class="type-file-show">
          		<img class="show_image" src="<?php echo TEMPLATES_PATH;?>/images/preview.png" />
          		<div class="type-file-preview"><img src="<?php if(is_file(BasePath.DS.ATTACH_ACTIVITY.DS.$output['activity']['activity_banner'])){echo SiteUrl."/".ATTACH_ACTIVITY."/".$output['activity']['activity_banner'];}else{echo SiteUrl."/templates/".TPL_NAME."/images/sale_banner.jpg";}?>" onload="javascript:DrawImage(this,500,500);"></div>
            </span>
        ...
        <tr>
          <td colspan="2" class="required"><label class="validation" for="activity_desc"><?php echo $lang['activity_new_desc'];?>:</label></td>
        </tr>
        <tr class="noborder">
...
$(document).ready(function(){
	...
	$("#add_form").validate({
        ...
        messages : {
	    	...
	    	activity_desc: {
	    		required : '<?php echo $lang['activity_new_desc_null'];?>'
	    	},
	    	activity_sort: {
