      ...
      <tbody>
        <tr class="hover edit">
          ...
          <td class="align-center power-onoff">
            <a href="JavaScript:void(0);" class="tooltip <?php if($v['recommend'] == 0){ ?>disabled<?php }else{ ?>enabled<?php }?>" fieldvalue="<?php echo $v['recommend'];?>" fieldid="<?php echo $v['mtag_id'].','.$v['member_id'];?>" ajax_branch="mtagmember_recommend" fieldname="recommend" nc_type="inline_edit" title="<?php echo $lang['nc_editable'];?>"><img src="<?php echo TEMPLATES_PATH;?>/images/transparent.gif"></a>
          </td>
