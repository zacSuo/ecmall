...
<div class="page">
  ...
  <table class="table tb-type2 nobdb">
    <tbody>
      ...
      <tr class="noborder">
        <td class="vatop rowform"><?php echo $output['rechargepaystate'][$output['info']['pdr_paystate']];?></td>
        <td class="vatop tips"></td>
      </tr>
      <!-- 显示管理员名称 -->
      ...
      <?php }?>
      <?php if (trim($output['info']['pdr_adminremark']) != ''){ ?>
      <tr>
        <td colspan="2" class="required"><label><?php echo $lang['admin_predeposit_adminremark'];?>:</label></td>
      </tr>
      <tr class="noborder">
        <td class="vatop rowform"><div style="width:300px;"><?php echo $output['info']['pdr_adminremark'];?></div></td>
        <td class="vatop tips"></td>
      </tr>
      <?php }?>
    </tbody>
  ...
  <table class="table tb-type2 nobdb">
    <tbody>
      <tr>
        <td><input type="button" value="<?php echo $lang['admin_predeposit_backlist']; ?>" class="btn big" onclick="window.location.href='index.php?act=predeposit&op=predeposit'"></td>
      </tr>
    </tbody>
  </table>
</div>
