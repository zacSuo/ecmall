      ...
      <tbody>
        ...
        <tr class="noborder">
          <td class="vatop rowform" style=" height:48px;">
              ...
              <li class="red"><em></em><i></i><?php echo $lang['web_config_style_red'];?></li>
              <li class="pink"><em></em><i></i><?php echo $lang['web_config_style_pink'];?></li>
              <li class="orange"><em></em><i></i><?php echo $lang['web_config_style_orange'];?></li>
              <li class="green"><em></em><i></i><?php echo $lang['web_config_style_green'];?></li>
              <li class="blue"><em></em><i></i><?php echo $lang['web_config_style_blue'];?></li>
              <li class="purple"><em></em><i></i><?php echo $lang['web_config_style_purple'];?></li>
              <li class="brown"><em></em><i></i><?php echo $lang['web_config_style_brown'];?></li>
              <li class="gray"><em></em><i></i><?php echo $lang['web_config_style_gray'];?></li>
            </ul></td>
